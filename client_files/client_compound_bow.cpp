...
void CompoundBow::load_front_walking_sprite() {
...
void CompoundBow::load_back_walking_sprite() {
...
void CompoundBow::load_left_walking_sprite() {
...
void CompoundBow::load_right_walking_sprite() {
